...
const xp = zd(Ep),
  ...
  Gh = () => {
    ...
    const A = {
      ...
      p = rl.filter((L) => [12, 13, 21, 22, 23].includes(L.id));
  ...
  nv = () =>
    G.jsxs("div", {
      className: "bg-light",
      children: [G.jsx(Zh, {}), G.jsx(ev, {}), G.jsx(Gh, {}), G.jsx(tv, {})],
    }),
  rv = () => G.jsx(nv, {});
Vd.createRoot(document.getElementById("root")).render(
  G.jsx(Nn.StrictMode, { children: G.jsx(rv, {}) })
);
