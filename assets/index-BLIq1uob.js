...
const Ym = Wu(Km),
  ...
  wv = [8, 0, 1, 3, 11].map((l) => $e[l]),
  Sv = [0, 1, 3, 11].map((l) => $e[l]),
  kv = [8, 0, 1, 3, 11].map((l) => $e[l]),
  xv = [0, 1, 3, 11].map((l) => $e[l]),
  Ev = [0, 1, 3, 11].map((l) => $e[l]),
  Cv = [8, 0, 1, 3].map((l) => $e[l]),
  _v = [0, 1, 3, 12].map((l) => $e[l]),
  Pv = [0, 1, 3, 11].map((l) => $e[l]),
  Ov = [8, 0, 1, 3, 11].map((l) => $e[l]),
  Tv = [0, 1, 2, 3, 10, 11].map((l) => $e[l]),
  Lv = [9, 10, 8, 0, 1, 3, 11].map((l) => $e[l]),
  Rv = [8, 0, 1, 3, 9].map((l) => $e[l]),
  Nv = [6, 0, 1, 3, 10].map((l) => $e[l]),
  jv = [0, 1].map((l) => $e[l]),
  zv = [0, 1].map((l) => $e[l]),
  Mv = [0, 1, 3].map((l) => $e[l]),
  Dv = [0, 1, 2, 3].map((l) => $e[l]),
  Iv = [0, 1, 2, 3].map((l) => $e[l]),
  bv = [0, 1, 3, 12].map((l) => $e[l]),
  Fv = [3, 4, 5].map((l) => $e[l]),
  Hv = [4, 5, 7].map((l) => $e[l]),
  Wv = [0, 1, 3, 6].map((l) => $e[l]),
  Uv = [8, 0, 1, 3].map((l) => $e[l]),
  Sl = [
    {
      id: 1,
      images: Fe[0].img,
